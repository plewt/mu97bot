...
;_ScreenCapture_CaptureWndClient
; ===============================================================================================================================
...
; #FUNCTION# ====================================================================================================================
; Name...........: _ScreenCapture_CaptureWndClient
; Description ...: Captures a screen shot of a specified window client area
; Syntax.........: _ScreenCapture_CaptureWndClient($sFileName, $hWnd[, $iLeft = 0[, $iTop = 0[, $iRight = -1[, $iBottom = -1[, $fCursor = True]]]]])
; Parameters ....: $sFileName   - Full path and extension of the image file
;                  $hWnd        - Handle to the window to be captured
;                  $iLeft       - X coordinate of the upper left corner of the client rectangle
;                  $iTop        - Y coordinate of the upper left corner of the client rectangle
...
; Credits .......: Thanks to SmOke_N for his suggestion for capturing part of the client window
; ===============================================================================================================================
Func _ScreenCapture_CaptureWndClient($sFileName, $hWnd, $iLeft = 0, $iTop = 0, $iRight = 0, $iBottom = 0, $fCursor = False)
	Local $tRect = _WinAPI_GetClientRect($hWnd)
	$iLeft += DllStructGetData($tRect, "Left")
	$iTop += DllStructGetData($tRect, "Top")
	$iRight += DllStructGetData($tRect, "Right") - DllStructGetData($tRect, "Left")
	$iBottom += DllStructGetData($tRect, "Bottom") - DllStructGetData($tRect, "Top")
...
;~  	ConsoleWrite(@CRLF & "Took : " & $TimeTook)
	...
	_ScreenCapture_SaveImage($sFileName, $hBMP)
	_WinAPI_DeleteObject($hBMP)
EndFunc   ;==>_ScreenCapture_CaptureWndClient
