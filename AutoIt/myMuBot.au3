...
#Region ### GUI ###
	...
	$inIdleDuration = GUICtrlCreateInput(String($cIdleDuration), 408, 148, 121, 21)
	GUICtrlSetTip(-1, "Время в конце итерации - чем больще, тем меньше нагрузка на проц")
	$inMainSkillDur = GUICtrlCreateInput(String($cMainSkillDuration), 408, 173, 121, 21)
	...
	$inSecondarySkillDur = GUICtrlCreateInput(String($cSecondarySkillDuration), 408, 198, 121, 21)
	If Not $cnSwitchSkill Then GUICtrlSetState(-1, $GUI_DISABLE)
	...
	$inLootDur = GUICtrlCreateInput(String($cLootIdleDuration), 408, 223, 121, 21)
	If Not $cnLoot Then GUICtrlSetState(-1, $GUI_DISABLE)
	GUICtrlSetTip(-1, "Столько итераций в перерывах между лутанием")
	...
	$inComeBackDur = GUICtrlCreateInput(String($cComeBackDuration), 408, 248, 121, 21)
	If Not $cnComeBack Then GUICtrlSetState(-1, $GUI_DISABLE)
	GUICtrlSetTip(-1, "Столько итераций не пытаемся вернуться")
	...
	$inHealthLowLevel = GUICtrlCreateInput(String($cHealthLowLevel), 408, 273, 121, 21)
	If Not $cnHeal Then GUICtrlSetState(-1, $GUI_DISABLE)
	GUICtrlSetTip(-1, "При таком проценте здоровья пьём хп")
	...
	$inManaLowLevel = GUICtrlCreateInput(String($cManaLowLevel), 408, 298, 121, 21)
	If Not $cnMana Then GUICtrlSetState(-1, $GUI_DISABLE)
	GUICtrlSetTip(-1, "При таком проценте маны пьём ману")
	...
	GUICtrlSetData(-1, "Lorencia|Dungeon|Dungeon3|Davias|Noria|Losttower|Losttower3|Losttower5|Losttower7|Arena|Atlans|Tarkan|Icarus|Kalima|CryWolf|Aida|Kantru|Kantru1|Stadium", String($cLocation))
